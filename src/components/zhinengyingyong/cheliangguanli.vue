    ...
    <div class="kuang">
      <ul class="ul1">
        ...
        >
          ...
          <el-table-column prop="address" label="车辆型号" align="center"></el-table-column>
          <el-table-column prop="jfje" label="车辆车牌" align="center"></el-table-column>
          <el-table-column prop="jfr" label="车身照片" align="center">
               <img src="../../../public/imgs/che.png" alt="">
          </el-table-column>
          <el-table-column prop="jfzt" label="车辆备注" align="center"></el-table-column>
          <el-table-column prop="zx" label="绑定车位" align="center"></el-table-column>
